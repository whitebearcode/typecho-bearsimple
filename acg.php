...
$("#loading").show();
            $(function() {
                ...
                function pageList() {
                    ...
                    var html = "<center><div class=\"ui circular labels\"><a class=\"ui label\">共" + n + "条</a><a class=\"ui label\">第" + page + "/" + max + "页</a>";
                    ...
                    html += '<a class=\"ui label\" href="#" data-page="' + max + '">尾页</a></div></center>';
                    var $html = $(html);
