    ...
    $.getScript("//cdn.staticfile.org/mathjax/2.7.4/MathJax.js?config=TeX-MML-AM_CHTML",function(){
MathJax.Hub.Config({linebreaks: { automatic: true },showMathMenu: false,messageStyle:'none',tex2jax: {inlineMath: [['$','$'], ['\\(','\\)']]}});
});
        //相册
...
$("#fontsizes").click();
    $(document).on('click','#fontsizes',function(){
