...
strJsPath = strJsPath.replace(/OwO.min.js/, "OwO.json")
            var defaultOption = {
                ...
                width: '100%',
                maxHeight: '250px',
                api: "https://deliver.application.pub/gh/whitebearcode/bearspace/assets/owo/OwO.json"
            };
            ...
            xhr.open('get', "https://deliver.application.pub/gh/whitebearcode/bearspace/assets/owo/OwO.json", true);
            xhr.send(null);
        }
...
strJsPath = strJsPath.replace(/OwO.min.js/, "")
                            var icon = "https://deliver.application.pub/gh/whitebearcode/bearspace/assets/owo/" + opackage[_i].icon;
                            html += '\n<li class="OwO-item" data-id="' + opackage[_i].data + '" title="' + opackage[_i].text + '">' + '<img class="lazyload" data-src="' + icon + '"/>' + '</li>';
                        } else {
                ...
                html += '\n                <div class="OwO-bar" style="overflow-y: auto;">\n                    <ul class="OwO-packages">';
