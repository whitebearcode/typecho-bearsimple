...
strJsPath = strJsPath.replace(/OwO.min.js/, "OwO.json")
            var defaultOption = {
                ...
                width: '100%',
                maxHeight: '250px',
                api: "https://cdn.jsdelivr.net/gh/whitebearcode/bearspace/assets/owo/OwO.json"
            };
            ...
            xhr.open('get', "https://cdn.jsdelivr.net/gh/whitebearcode/bearspace/assets/owo/OwO.json", true);
            xhr.send(null);
        }
...
strJsPath = strJsPath.replace(/OwO.min.js/, "")
                            var icon = "https://cdn.jsdelivr.net/gh/whitebearcode/bearspace/assets/owo/" + opackage[_i].icon;
