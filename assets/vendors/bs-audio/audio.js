...
(function (window) {
  ...
  BAudio.prototype = {
        ...
        <div class="BAudio-content">
          <headers class="BAudio-header">
            ...
            <div class="BAudio-container">
              <p class="BAudio-author">${this.music.artist}</p>
              <p class="BAudio-title">${this.music.name}</p>
            </div>
          </headers>
    ...
    ready: function () {
      ...
      element.querySelector('.BAudio-author').innerHTML = this.music.artist
      element.querySelector('.BAudio-title').innerHTML = this.music.name
