...
//水印设置
$(document).ready(function(){
$('#Watermark-0-130').change(function(){
var a18=$(this).children('option:selected').val();

if(a18=='1'){
$("#typecho-option-item-waterMarkImg-130").show();
$("#typecho-option-item-waterMarkAxisX-131").show();
$("#typecho-option-item-waterMarkAxisY-132").show();
$("#typecho-option-item-waterMarkSize-133").show();
$("#typecho-option-item-waterMarkColor-134").show();
}
else{
$("#typecho-option-item-waterMarkImg-130").hide();
$("#typecho-option-item-waterMarkAxisX-131").hide();
$("#typecho-option-item-waterMarkAxisY-132").hide();
$("#typecho-option-item-waterMarkSize-133").hide();
$("#typecho-option-item-waterMarkColor-134").hide();
}
})
var options18=$("#Watermark-0-130 option:selected").val();
if(options18 !== '1'){
$("#typecho-option-item-waterMarkImg-130").hide();
$("#typecho-option-item-waterMarkAxisX-131").hide();
$("#typecho-option-item-waterMarkAxisY-132").hide();
...
//海报
$(document).ready(function(){
$('#Poster-0-153').change(function(){
var a19=$(this).children('option:selected').val();

if(a19=='1'){
$("#typecho-option-item-Poster_Webname-153").show();
$("#typecho-option-item-Poster_WebDec-154").show();
$("#typecho-option-item-Poster_Bloger-155").show();
$("#typecho-option-item-Poster_QQ-156").show();
$("#typecho-option-item-Poster_QQsetting-157").show();
}
else{
$("#typecho-option-item-Poster_Webname-153").hide();
$("#typecho-option-item-Poster_WebDec-154").hide();
$("#typecho-option-item-Poster_Bloger-155").hide();
$("#typecho-option-item-Poster_QQ-156").hide();
$("#typecho-option-item-Poster_QQsetting-157").hide();
}
})
