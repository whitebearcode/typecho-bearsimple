...
if(a18=='1'){
$("#typecho-option-item-waterMarkImg-136").show();
$("#typecho-option-item-waterMarkAxisX-137").show();
$("#typecho-option-item-waterMarkAxisY-138").show();
$("#typecho-option-item-waterMarkSize-139").show();
$("#typecho-option-item-waterMarkColor-140").show();
}
else{
$("#typecho-option-item-waterMarkImg-136").hide();
$("#typecho-option-item-waterMarkAxisX-137").hide();
$("#typecho-option-item-waterMarkAxisY-138").hide();
$("#typecho-option-item-waterMarkSize-139").hide();
$("#typecho-option-item-waterMarkColor-140").hide();
}
})
