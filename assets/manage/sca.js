...
$('#Popup-0-109').change(function(){
var a6=$(this).children('option:selected').val();

if(a6=='1'){
$("#typecho-option-item-PopupText-109").show();
    $("#typecho-option-item-PopupUrl-110").show();
}
else{
$("#typecho-option-item-PopupText-109").hide();
    $("#typecho-option-item-PopupUrl-110").hide();
}
})
var options6=$("#Popup-0-109 option:selected").val();
if(options6 !== '1'){
$("#typecho-option-item-PopupText-109").hide();
    $("#typecho-option-item-PopupUrl-110").hide();
}
...
if(a9=='11'){
$("#typecho-option-item-WorldLanguage-103").show();
}
else{
$("#typecho-option-item-WorldLanguage-103").hide();
}
})
...
//评论字数限制
$(document).ready(function(){
$('#Entermaxlength-0-112').change(function(){
var a12=$(this).children('option:selected').val();

if(a12=='1'){
$("#typecho-option-item-Entermaxlengths-112").show();
}
else{
$("#typecho-option-item-Entermaxlengths-112").hide();
}
})
var options12=$("#Entermaxlength-0-112 option:selected").val();
if(options12 !== '1'){
$("#typecho-option-item-Entermaxlengths-112").hide();
}
})
...
//音乐歌单
$(document).ready(function(){
$('#music-0-123').change(function(){
var a20=$(this).children('option:selected').val();

if(a20=='1'){
$("#typecho-option-item-music-122").hide();
$("#typecho-option-item-music_bof-123").show();
$("#typecho-option-item-music_sxj-124").show();
$("#typecho-option-item-music_musicList-125").show();
}
else{
$("#typecho-option-item-music-122").hide();
...
if(a21=='1'){
$("#typecho-option-item-EditorsAutosave-151").show();
}
else{
$("#typecho-option-item-EditorsAutosave-151").hide();
}
})
