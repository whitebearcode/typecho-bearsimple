...
//编辑器
$(document).ready(function(){
$('#Editors-0-121').change(function(){
var a21=$(this).children('option:selected').val();

if(a21=='1'){
$("#typecho-option-item-EditorsAutosave-150").show();
}
else{
$("#typecho-option-item-EditorsAutosave-150").hide();
}
})
var options21=$("#Editors-0-121 option:selected").val();
if(options21 !== '1'){
$("#typecho-option-item-EditorsAutosave-150").hide();
}
})
