...
<img data-fancybox="image" data-caption="$2" class="bearmark lazyload lazyload-style-'.$options['Lazyload_style'].'" '.lazyload(1).'src="$1"   alt="'.$title.'" title="点击放大图片">'.$alt; 
 ...
 $replacement = '
  <a class="card">
    <div class="image">
      <img data-fancybox="image" data-caption="$2" class="bearmark lazyload lazyload-style-'.$options['Lazyload_style'].'" '.lazyload(1).'src="$1"   alt="$2" title="点击放大图片">
    </div>
  </a>'; 
    $content = preg_replace($pattern, $replacement, $content);
...
<img class="pure-img lazyload lazyload-style-'.$options['Lazyload_style'].'" '.lazyload(1).'src="$1"   alt="$2" title="$2">'.$alt; 
 ...
 $replacement = '
  <a class="card">
    <div class="image">
      <img data-fancybox="image" data-caption="$2" '.lazyload(1).'src="$1" class="'.$mark.' lazyload lazyload-style-'.$options['Lazyload_style'].'"   alt="$2" title="点击放大图片">
    </div>
  </a>'; 
    $content = preg_replace($pattern, $replacement, $content);
