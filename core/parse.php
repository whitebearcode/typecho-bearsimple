...
function ShortCode($post,$t,$login,$articletype,$modetype='noreadmode'){
 ...
 $replacement = '
<img class="pure-img bearmark lazyload lazyload-style-'.$options['Lazyload_style'].'" '.lazyload(1).'src="$1"  alt="$2" title="点击放大图片">'.$alt; 
    $content = preg_replace($pattern, $replacement, $content);
...
<img class="pure-img lazyload lazyload-style-'.$options['Lazyload_style'].'" '.lazyload(1).'src="$1"   alt="$2" title="$2">'.$alt; 
 ...
 $replacement = '
  <a class="card">
    <div class="image">
      <img '.lazyload(1).'src="$1" class="bearmark lazyload lazyload-style-'.$options['Lazyload_style'].'"   alt="$2" title="点击放大图片">
    </div>
  </a>'; 
    $content = preg_replace($pattern, $replacement, $content);
