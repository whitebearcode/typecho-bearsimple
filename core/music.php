...
if(Typecho_Widget::widget('Widget_Options')->music_sxj=='0'){	
    ...
    public static function footer(){
        $options = Typecho_Widget::widget('Widget_Options');  $musicList = $options->musicList;
 if(empty($musicList)){
       $musicList = "761323";
      }
...
if(Typecho_Widget::widget('Widget_Options')->music_bof=='1'){	
        ...
        echo '<script  src="'.Helper::options()->themeUrl . '/assets/music/js/player.js" data-no-instant></script><script  src="'.Helper::options()->themeUrl . '/assets/music/js/prbug.js"></script>' . "\n";        
    }
