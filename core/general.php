...
';if($options->Like == '1'){echo'
  <div class="ui button" tabindex="0" id="agree-btn" data-cid="'.$thi->cid.'" data-url="'.$thi->permalink.'">
    <i class="heart red icon"></i>赞 (<b class="agreenum">'.$agree['agree'].'</b>)
  </div>
  ';}
