...
<footer id="footer" role="contentinfo" class="break">
 <?php if($this->options->CustomizationFooterCode): ?><?php $this->options->CustomizationFooterCode(); ?><br><?php endif; ?>
    ...
    <?php _e('Powered by <a href="http://www.typecho.org">Typecho</a> | Template by <a href="https://github.com/whitebearcode/typecho-bearsimple">BearSimple</a>  '); ?><?php if($this->options->load_Time == '2'): ?><br><?php echo loadtime();?><?php endif; ?>
...
<?php if($this->options->Read_Process == '1') :?>
		...
		'search':"<?php if(!empty($this->options->Search[0])){echo count($this->options->Search);}else{echo 0;}; ?>",
...
<?php if($this->options->Slidersss == '1' && $this->options->SliderIndexs == '1' || $this->options->SliderOthers == '1') :?>
		...
		<?php endif; ?>
		<?php if($this->options->Comment_like == "2"): ?>
		'CommentLike': "true",
...
<?php if($this->options->Authorz == '1' && !empty($this->options->AuthorAvatarClickText)) :?>
    ...
    'Share':'true',
    <?php if(!empty($this->options->Shares[0]) && @in_array('wechat',$this->options->Shares)) :?>
    'Sharewechat':'true',
    <?php endif; ?>
    <?php endif; ?>
...
<?php endif; ?>
<?php if($this->options->CustomizationFooterJsCode): ?><?php $this->options->CustomizationFooterJsCode(); ?><?php endif; ?>
