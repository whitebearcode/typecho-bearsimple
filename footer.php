...
<footer id="footer" role="contentinfo" class="break">
 <?php if($this->options->CustomizationFooterCode): ?><?php $this->options->CustomizationFooterCode(); ?><br><?php endif; ?>
    ...
    <?php _e('由 <a href="http://www.typecho.org">Typecho</a> 强力驱动 | 主题:<a href="https://github.com/whitebearcode/typecho-bearsimple">ʕ•ᴥ•ʔ BearSimple</a>  '); ?><?php if($this->options->load_Time == '2'): ?><br><?php echo loadtime();?><?php endif; ?>
