...
<script src="<?php AssetsDir();?>assets/js/lightbox-plus-jquery.min.js"></script>
<?php endif; ?>
...
<script src="<?php AssetsDir();?>modules/tw_cn.js"></script>
<script type="text/javascript">
...
if(document.getElementById("comments")) {
    ...
    $.getScript('<?php AssetsDir();?>assets/owo/OwO.min.js');
