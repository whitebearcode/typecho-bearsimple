...
$.pjax({
url:$(this).attr("hrefs"),
container:pjax_id,fragment:pjax_id, timeout:10000
})
})
...
<?php endif; ?>
    $(function() {
        $.getScript("https://cdn.jsdelivr.net/gh/whitebearcode/Translate/20211019/element.js?cb=googleTranslateElementInit2", function(){
        })
$("body").on('click', 'span',
function() {
    var thisEle = $("#para").css("font-size");
