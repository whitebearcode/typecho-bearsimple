...
<?php if(in_array('header',$this->options->Search)) :?>   
 ...
 <div style="display:flex;float:right;margin-top:<?php if ($this->options->Translate == "1" || $this->options->Translate == "11"): ?>-8<?php else: ?>-5<?php endif; ?>em"><div class="ui large icon input pc">
