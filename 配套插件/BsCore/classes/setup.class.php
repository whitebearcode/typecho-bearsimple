...
//                }
        ...
        public static function get_enqueue_style($header = null)
        {
            ...
            if ($loads_statics) { // if is plugin
                ...
                $style = '<link rel="stylesheet" href="https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/5.15.4/css/all.min.css?ver=5.15.4">' .
                    '<link rel="stylesheet" href="https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/font-awesome/5.15.4/css/v4-shims.min.css?ver=5.15.4">'.
                    ...
                    '<link href="https://lf6-cdn-tos.bytecdntp.com/cdn/expire-1-M/fomantic-ui/2.8.8/semantic.min.css" rel="stylesheet">' .
                    '<link href="https://lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/toastr.js/2.1.4/toastr.min.css" type="text/css" rel="stylesheet" />' .
        ...
        public static function get_enqueue_script($old = null)
        {
            ...
            if ($loads_statics) { // if is plugin
                ...
                $script = '<script src="' . self::include_plugin_url('assets/js/lodash.min.js') . '?v=2.0.5"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/plugins.min.js') . '?v=2.0.6"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/main.min.js') . '?v=2.1.8"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/iris.min.js') . '?v=2.0.5"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/color-picker.min.js') . '?v=2.0.5"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/jquery/ui/core.min.js') . '?v=2.0.5"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/jquery/ui/draggable.min.js') . '?v=2.0.5"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/jquery/ui/mouse.min.js') . '?v=2.0.5"></script>' .
                    '<script src="' . self::include_plugin_url('assets/js/jquery/ui/menu.min.js') . '?v=2.0.5"></script>' .
                    '<script src="//lf9-cdn-tos.bytecdntp.com/cdn/expire-1-M/toastr.js/2.1.4/toastr.min.js"></script>'.
                    '<script src="' . self::include_plugin_url('assets/js/backend.js') . '?v=2.0.5"></script>'.
