        ...
        public static function get_enqueue_script($old = null)
        {
            ...
            if ($loads_statics) { // if is plugin
                ...
                $script = '<script src="' . self::include_plugin_url('assets/js/lodash.min.js') . '?v=2.2.4"></script>' .
                    ...
                    '<script src="//cdn.staticfile.org/jquery-tokeninput/1.6.0/jquery.tokeninput.min.js?v=2.2.4"></script>'.
                    ...
                    '<script src="' . self::include_plugin_url('assets/js/backend.js') . '?v=2.2.9.1"></script>'.
