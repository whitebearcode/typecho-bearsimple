                        ...
                        if ((itemLength == 1 && cbd.items[0].kind == 'file')
                            ...
                            for (var i = 0; i < cbd.items.length; i++) {
                                ...
                                if(item.kind == "file") {
                                    ...
                                    var uploadingText = '文件上传中(进度：'+Math.floor(Math.random() * (100 - 1 + 1) + 1)+'%)...';
                                    var uploadFailText = '文件上传失败(' + blob.name + ')'
                                    editor.codemirror.doc.replaceSelection(uploadingText);
                                    $.ajax({
                                        method: 'post',
                                        ...
                                        defaultValue = defaultValue.replace(uploadingText,'');
                                        editor.codemirror.doc.setValue(defaultValue);
