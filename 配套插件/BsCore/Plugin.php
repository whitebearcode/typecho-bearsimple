...
public static $cache = null;
    ...
    public static function activate()
    {
        ...
        \Typecho\Plugin::factory('Widget_Abstract_Contents')->contentEx = [__CLASS__, 'replace'];
        \Typecho\Plugin::factory('Widget_Abstract_Contents')->excerptEx = [__CLASS__, 'replace'];
        }
 ...
 public static function replace($text, $widget, $lastResult)
    {
        ...
        if($options['Link_blank'] == '1'){
            $target = '';
        }
        elseif($options['Link_blank'] == '2'){
