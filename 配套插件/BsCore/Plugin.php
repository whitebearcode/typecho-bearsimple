    ...
    public static function C()
    {
        ...
        try {
            ...
            if (!empty($data)) {
               ...
               $html = str_replace($_SERVER['SERVER_ADDR'],$op->siteUrl,$data['html']);
         echo $html;
                die;
            }
        } catch (Exception $e) {
...
<script src="<?php echo Helper::options()->pluginUrl ?>/BsCore/modules/bs-emoji/bs-emoji.js"></script>
...
cancelButtonText: "取消", 
  ...
  inputValidator: (valuethree) => {
    return new Promise((resolve) => {
      ...
      title: '第四步 填写倒计时结束日期',
  input: 'text',
  inputLabel: '按照年-月-日 时:分:秒来填写，如2022-12-12 23:12:12',
...
cancelButtonText: "取消", 
  ...
  inputValidator: (valuefour) => {
    return new Promise((resolve) => {
      if (valuethree !== '') {
                var text = '[bsdate color="'+valueone+'" start="'+valuethree+'" end="'+valuefour+'"]'+valuetwo+'[/bsdate]';
      dateprogress(text);
    resolve()
      }
      else{
...
template: '<div class="colorpicker">' +
  ...
  public static function uploadHandle(array $file)
  {
    if(bsOptions::getInstance()::get_option( 'bearsimple' )['Tinypng_open'] == true){
        ...
        if ($isimage) {
            $apikey = bsOptions::getInstance()::get_option( 'bearsimple' )['Tinypng_apikey'];
