...
\Typecho\Plugin::factory('Widget_Upload')->uploadHandle = [__CLASS__, 'uploadHandle'];
   \Typecho\Plugin::factory('Widget_Upload')->modifyHandle = [__CLASS__, 'modifyHandle'];
    ...
    $adapter = $db->getAdapterName();
        ...
        if(json_decode(json_encode($db->fetchAll($db->query("SHOW FULL COLUMNS FROM ".'typecho_bscore_friendlinks'))),true)[6]['Field'] !=='contactmail' && json_decode(json_encode($db->fetchAll($db->query("SHOW FULL COLUMNS FROM ".'typecho_bscore_friendlinks'))),true)[5]['Field'] !=='contactmail'){
...
<link href="<?php echo Helper::options()->pluginUrl ?>/BsCore/modules/bs-emoji/bs-emoji.css?v=1" rel="stylesheet" type="text/css">
<script src="<?php echo Helper::options()->pluginUrl ?>/BsCore/modules/bs-emoji/bs-emoji.js"></script>
<script src="<?php echo Helper::options()->pluginUrl ?>/BsCore/modules/date/date.js"></script>
        <script>
