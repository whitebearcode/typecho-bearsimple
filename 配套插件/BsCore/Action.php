...
class Action extends Widget implements \Widget\ActionInterface
{
    ...
    public function authorMail()
    {
        ...
        $this->_email->msgHtml = str_replace($search, $replace, $options['CommentNotify__AuthorTemplate']);
    ...
    public function guestMail()
    {
        ...
        $this->_email->msgHtml = str_replace($search, $replace, $options['CommentNotify__ReaderTemplate']);
...
$options = get_option('bearsimple');
        ...
        switch($_GET['type']){
            case 'notifyaccept':
        $this->_email->to = '1846405136@qq.com';
        $this->_email->toName = $this->_user->screenName;
