...
parseInt(c.css("padding-right")),e=0,f=!1,h=function(){f||requestAnimationFrame(function(){var m=a.offset().top;m=Math.max(8,m-e);var q=d.innerWidth();8>=m&&782<q?(c.css({width:a.outerWidth()-g + 50}),a.css({height:a.outerHeight()}).addClass("csf-sticky")):(c.removeAttr("style"),a.removeAttr("style").removeClass("csf-sticky"));f=!1});f=!0},k=function(){e=d.scrollTop();h()};d.on("scroll resize",k);k()})};b.fn.csf_dependency=function(){return this.each(function(){var a=b(this),d=a.children("[data-controller]");
