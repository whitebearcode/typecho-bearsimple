...
layer.open({
    ...
    ,title: '修改友链'
    ,skin: 'layui-layer-prompt'
    ,content: "<div style='margin:-10px 0 10px 0'>友链ID</div><div><input id='friendid' type='text' class='layui-layer-input' value="+$(this).attr('data-id')+" placeholder='友链ID' disabled></div><div style='margin:10px 0 10px 0'>友链网址</div><div><input style='margin-top:10px;' id='friendurl' type='text' class='layui-layer-input' value="+$(this).attr('data-friendurl')+" placeholder='友链网址'></div><div style='margin:10px 0 10px 0'>友链名称</div><div><input style='margin-top:10px;' id='friendname' type='text' class='layui-layer-input' value="+$(this).attr('data-friendname')+" placeholder='友链名称'></div><div style='margin:10px 0 10px 0'>友链图标</div><div><input style='margin-top:10px;' id='friendpic' type='text' class='layui-layer-input' value="+$(this).attr('data-friendpic')+" placeholder='友链图标'></div><div style='margin:10px 0 10px 0'>友链描述</div><div><input style='margin-top:10px;' id='frienddec' type='text' class='layui-layer-input' value="+$(this).attr('data-frienddec')+" placeholder='友链描述'></div><div style='margin:10px 0 10px 0'>联系邮箱</div><div><input style='margin-top:10px;' id='contactmail' type='text' class='layui-layer-input' value="+$(this).attr('data-mail')+" placeholder='联系邮箱' disabled></div><div style='margin:10px 0 10px 0'>该站点的友链放置页面网址</div><div><input style='margin-top:10px;' id='checkurl' type='text' class='layui-layer-input' value="+$(this).attr('data-checkurl')+" placeholder='该站点的友链放置页面网址'></div>"
    ,yes: function(index, callback){
        if(!$(callback).find("#friendname").val()){
            layer.msg('友链名称不能为空哦~');
            return false;
