        ...
        <div>
            <div class="bearui_config__aside">
                ...
                <ul class="tabs">
                    ...
                    <?php if($this->user->group !== 'subscriber' && $this->user->submission == '1' && Bsoptions('UserCenter_tougaoOpen') == true):?>
...
<?php if(trim(' ',Bsoptions('UserCenter_tips')) !== ''):?>
...
<?php endif;?>
  ...
  <ul class="list">
    ...
    <li>您的等级:<?php echo user_tier($this->user->coins); ?></li>
...
<div class="ui bottom attached tab " data-tab="second">
 ...
 <div class="title">
    <i class="dropdown icon"></i>
    <?php echo $systemtz['UserCenter_tongzhi_title'];?> - <?php $date = DateTime::createFromFormat('d/m/Y', $systemtz['UserCenter_tongzhi_date']); echo $date->format('Y年m月d日');?>
  </div>
  <div class="content">
    <p class="transition hidden"><?php echo $systemtz['UserCenter_tongzhi_text'];?></p>
  </div>
<?php endforeach; ?>
<?php endif; ?>
...
<script>
  ...
  $(document).ready(function() {
      ...
      $.getScript('<?php AssetsDir();?>assets/vendors/usercenter/usercenter.min.js');

        const editor = new FroalaEditor('#tougao_textarea',
  {language: 'zh_cn',
      quickInsertButtons: ['image', 'table', 'ol', 'ul'],
    pluginsEnabled: ['image', 'table', 'lists','charCounter','fullscreen','link'],
