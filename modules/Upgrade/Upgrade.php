...
$file_url  = 'https://upgrade.typecho.co.uk/Bearsimple/bearsimple_lastest_update.zip';
...
$archive->extract(PCLZIP_OPT_PATH,$_SERVER['DOCUMENT_ROOT'].'/usr/plugins',PCLZIP_OPT_BY_PREG, "/^BsCore/");
$archive->extract(PCLZIP_OPT_PATH,$_SERVER['DOCUMENT_ROOT'].'/usr/themes',PCLZIP_OPT_BY_PREG, "/^bearsimple/");
unlink($tmp_path);
$data['code']     = '1';
	$data['message']  = 'success';
echo json_encode($data, JSON_UNESCAPED_UNICODE);
