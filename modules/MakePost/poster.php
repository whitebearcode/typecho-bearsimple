...
<script>
    ...
    $(document).ready(function(){
        $(document).on('click', '.bearstudio_poster_a', function(e) {
    ...
    function show_bearstudio_poster_ykzn(){
        if(bearstudio_poster_start_wlat == 0){
            ...
            var html = '<div id="bearstudio_poster_box" class="bearstudio_poster_nchxd">\n' +
                ...
                '<div class="bearstudio_poster_img"><div class="img_time"><?php $this->date('d'); ?><span><?php $this->date('Y'); ?>/<?php $this->date('m'); ?></span></div><img src="https://pic-api.bear-studio.net/1000/700" class="vm" id="bearstudio_poster_image"></div>\n' +
                '<div class="bearstudio_poster_tita"><?php $this->title(); ?></div>\n' +
                '<div class="bearstudio_poster_txta"><?php $this->excerpt(20, '...');?></div><div class="bearstudio_poster_x guig"></div>\n' +
