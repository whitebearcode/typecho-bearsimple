...
<div class="post-meta"><time datetime="<?php $this->date('c'); ?>" itemprop="datePublished"><?php $this->date(); ?></time><?php if($this->fields->Hot == '1'): ?> | </span><span><i class="hotjar icon"></i>热度:<?php _e(getViewsStr($this));?>°C</span><?php endif; ?><span> | </span> <span class="ui mini gray icon button" size="bigger" >A+</span><span class="ui mini gray icon button" size="smaller" >A-</span><?php if($this->user->group == 'administrator'): ?>|  <a href="<?php $this->options->adminUrl('/write-page.php?cid='.$this->cid); ?>" class="ui mini gray icon button"><i class="pencil icon"></i></a><?php endif; ?><?php if($this->options->Poster == '1' && $this->fields->Poster == '1'): ?>| <?php ArticlePoster::button($this->cid); ?><?php endif; ?></div>
...
if ($this->options->Lightbox == '1' || $this->options->Watermark == '1'){
    $pattern = '/\<img.*?src\=\"(.*?)\"[^>]*>/i';
    $replacement = '<div class="line-block" data-type="image"><img class="layimg" src="$1" data-img2blob="$1" alt="'.$this->title.'" title="点击放大图片"></div>';
...
<div class="ui icon message">
  ...
  <div class="content">
    ...
    <p style="word-break:break-all;">本文链接： <?php echo $this->permalink() ?></p>
  </div>
</div>
<?php endif; ?>
<?php if($this->options->Share == '1'): ?>
<link rel="stylesheet" type="text/css" href="/usr/themes/bearsimple/assets/share/share.min.css"/>
 <div style="transform:translateY(100%);-ms-transform:translateY(100%);-webkit-transform:translateY(100%);text-align:center;" id="share" data-sites="<?php $this->need('modules/share.php'); ?>"></div><br>
<br><br>
<?php endif; ?>
