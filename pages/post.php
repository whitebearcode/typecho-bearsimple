...
<div class="bs-scrollnav-v" id="article-nav" style="background-color: rgba(255,255,255,.9);border: 1px solid #ebebeb;float:left;"><bsnav class="bs-close ax-iconfont ax-icon-arrow-right"></bsnav></div>
<?php endif; ?>
<?php endif; ?>

<?php if($this->options->Readmode == "1"): ?> 
<?php echo readModeContent($this,ShortCode($this->content,$this,$this->user->hasLogin())); ?>
<?php endif; ?>
