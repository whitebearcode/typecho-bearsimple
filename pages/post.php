...
<div class="bs-scrollnav-v" id="article-nav" style="background-color: rgba(255,255,255,.9);border: 1px solid #ebebeb;float:left;"><a href="##" class="bs-close ax-iconfont ax-icon-arrow-right"></a></div>
<?php endif; ?>
<?php endif; ?>
...
<div class="post-meta"><time datetime="<?php $this->date('c'); ?>" itemprop="datePublished"><?php $this->date(); ?></time><span> | </span><span class="category"><?php $this->category(','); ?></span><?php if($this->fields->Hot == '1'): ?> | </span><span><i class="hotjar icon"></i>热度:<?php _e(getViewsStr($this));?>°C</span><?php endif; ?> | <span class="ui mini gray icon button" id="smallsize">小</span><span class="ui mini gray icon button" id="middlesize">中</span><span class="ui mini gray icon button" id="bigsize">大</span><?php if($this->user->group == 'administrator'): ?>|  <a href="<?php $this->options->adminUrl('/write-post.php?cid='.$this->cid); ?>" class="ui mini gray icon button"><i class="pencil icon"></i></a><?php endif; ?><?php if($this->options->Poster == '1' && $this->fields->Poster == '1'): ?>| <a href="#" onclick="show_bearstudio_poster_ykzn();return false;" class="ui mini gray icon button">生成微海报</a><?php endif; ?> </div>
