...
<link rel="stylesheet" type="text/css" href="/usr/themes/bearsimple/assets/share/share.min.css"/>
 <div style="transform:translateY(100%);-ms-transform:translateY(100%);-webkit-transform:translateY(100%);float:right;" id="share" data-sites="<?php $this->need('modules/share.php'); ?>"></div>
 <?php endif;?><br>
<br>
