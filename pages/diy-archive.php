...
<?php if($this->options->Article_forma == "1"): ?>		
   <?php while($this->next()): ?>
<div class="ui <?php if($this->options->textType == "1"): ?>raised<?php endif; ?><?php if($this->options->textType == "2"): ?>stacked<?php endif; ?><?php if($this->options->textType == "3"): ?>tall stacked<?php endif; ?><?php if($this->options->textType == "4"): ?>piled<?php endif; ?> divided items segment" <?php if($this->options->articleradius): ?>style="border-radius:<? $this->options->articleradius(); ?>px"<?php endif; ?>>
  <div class="item">
  ...
  <div class="rounded image">
    ...
    <div class="content" style="margin-top:10px;margin-left:20px">
      ...
      <div class="extra">
        ...
        <p class="readmore" style="margin-top:<?php if(thumb($this) !== "null"): ?>25px<?php else :?>15px<?php endif; ?>"><a href="<?php $this->permalink() ?>">阅读全文</a></p>
      </div>
    </div>
  </div></div>
 	<?php endwhile; ?>
