...
<?php if($this->options->AdControl4 == '1') :?>
<a href="<?php $this->options->AdControl4Url() ?>">
  <img style="display: inline-block; width: 100%; max-width: 100%; height: auto;" src="<?php $this->options->AdControl4Src() ?>"> </a>
  <?php endif; ?><?php endif; ?>
...
<?php if($this->options->Slidersss == '1' && $this->options->SliderOthers == '1') :?>
  <div class="swiper-container" id="swiper">
    <div class="swiper-wrapper">
        ...
        <div class="swiper-slide"><img class="swiper-slide" src="<?php $this->options->themeUrl() ?>/modules/TimThumb/TimThumb.php?src=<?php echo $sliderpic;?>&h=230&w=547"></div>
        <?php } ?>
    </div>
...
<?php if($this->fields->excerpt == null): ?>
			...
			<a href="<?php $this->permalink() ?>"><?php $this->excerpt($this->options->articleexcerptnum, '...'); ?></a>
			<?php else : ?>
...
<?php if($this->options->Article_forma == "1"): ?>		
   <?php while($this->next()): ?>
<div class="ui <?php if($this->options->textType == "1"): ?>raised<?php endif; ?><?php if($this->options->textType == "2"): ?>stacked<?php endif; ?><?php if($this->options->textType == "3"): ?>tall stacked<?php endif; ?><?php if($this->options->textType == "4"): ?>piled<?php endif; ?> divided items segment" style="<?php if($this->options->articleradius): ?>border-radius:<? $this->options->articleradius(); ?>px;<?php endif; ?>">
  <div class="item">
...
<?php if(thumb($this) !== "null"): ?>
  <div class="image" style="margin-top:auto;margin-bottom:auto">
     <!--给文章加上内页链接 -->
				    <?php if($this->options->ALABEL == '1'): ?>
			<a href="<?php $this->permalink() ?>">
      <img style="width:180px;height:100px;border-radius:10px" src="<?php $this->options->themeUrl() ?>/modules/TimThumb/TimThumb.php?src=<?php echo thumb($this); ?>&h=230&w=547" alt="<?php $this->title() ?>">
      </a>
      <?php else : ?>
       <img style="width:180px;height:100px;border-radius:10px" src="<?php $this->options->themeUrl() ?>/modules/TimThumb/TimThumb.php?src=<?php echo thumb($this); ?>&h=230&w=547" alt="<?php $this->title() ?>">
      <?php endif; ?>
    ...
    <div class="content" style="margin-left:20px">
      <h2 class="post-title"><?php $this->sticky() ?><a href="<?php $this->permalink() ?>" class="header" style="margin-top:5px"><?php $this->title($this->options->articletitlenum, '...') ?></a></h2>
       <?php if(empty($this->options->articleexcerptnum)){$number="160" ;}else{$number = $this->options->articleexcerptnum;} ?>
