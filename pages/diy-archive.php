   ...
   <?php while($this->next()): ?>
			<div class="bs-col" hrefs="<?php $this->permalink() ?>">
				<div class="bs-card" <?php if($this->options->articleradius): ?>style="border-radius:<?php $this->options->articleradius(); ?>px"<?php endif; ?>>
					...
					<img <?php if($this->options->articleradius): ?>style="border-radius:<? $this->options->articleradius(); ?>px <?php $this->options->articleradius(); ?>px 0 0"<?php endif; ?> src="<?php $this->options->siteUrl() ?>/index.php/bearthumb?img=<?php echo thumb($this); ?>" alt="">
					<?php endif; ?>
