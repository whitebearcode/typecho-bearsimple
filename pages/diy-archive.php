...
<?php if($this->options->AdControl4 == '1' && !empty($this->options->AdControl4Src)) :?>
<?php billboard($this->options->AdControl4Src,'other'); ?>
  <?php endif; ?><?php endif; ?>
  
<?php if($this->options->Slidersss == '1' && $this->options->SliderOthers == '1') :?>
  <div class="splide">
...
<div class="ui vertical segment">
 ...
 <h2 class="post-title"><a href="<?php $this->permalink() ?>" class="header" style="margin-top:5px"><?php $this->title(articletitlenum(), '...') ?></a> 	<?php if($this->options->Article_time2 == "1"): ?><div class="ui gray horizontal label"><?php $this->date(); ?></div><?php endif; ?></h2>
  <p>
   ...
   <?php while($this->next()): ?>
			<div class="bs-col" hrefs="<?php $this->permalink() ?>">
				<div class="bs-card" <?php if($this->options->articleradius): ?>style="border-radius:<?php $this->options->articleradius(); ?>px"<?php endif; ?>>
					...
					<img <?php if($this->options->articleradius): ?>style="border-radius:<? $this->options->articleradius(); ?>px <?php $this->options->articleradius(); ?>px 0 0"<?php endif; ?> class="lazyload" data-src="<?php $this->options->siteUrl() ?>/index.php/bearthumb?img=<?php echo thumb($this); ?>" alt="">
					<?php endif; ?>
<div class="bs-card-body" style="<?php if($this->options->articleradius): ?>border-radius:<?php if(thumb($this) == "null"): ?><?php $this->options->articleradius(); ?>px <?php $this->options->articleradius(); ?>px<?php else:?>0px 0px<?php endif; ?> <?php $this->options->articleradius(); ?>px <?php $this->options->articleradius(); ?>px;<?php endif; ?>margin-top:-5px">
  ...
  <div class="blog-card" <?php if($this->options->articleradius): ?>style="border-radius:<? $this->options->articleradius(); ?>px"<?php endif; ?>>
    ...
    <div class="description">
      <h1><a href="<?php $this->permalink() ?>"><?php $this->title(articletitlenum(), '...') ?></a></h1>
...
<div class="ui <?php if($this->options->textType == "1"): ?>raised<?php endif; ?><?php if($this->options->textType == "2"): ?>stacked<?php endif; ?><?php if($this->options->textType == "3"): ?>tall stacked<?php endif; ?><?php if($this->options->textType == "4"): ?>piled<?php endif; ?> segment" <?php if($this->options->articleradius): ?>style="border-radius:<? $this->options->articleradius(); ?>px"<?php endif; ?>>
    	...
    	<a href="<?php $this->permalink() ?>">
        <div class="post">
			<h1 class="post-title"><a itemprop="url" href="<?php $this->permalink() ?>"><?php $this->title(articletitlenum(), '...') ?></a></h1>
	<?php if($this->options->Article_time2 == "1" || $this->options->show_comment == '2' || $this->options->show_cate == '2'): ?>
<div class="post-meta">
...
<?php if($this->options->Slidersss == '1' && $this->options->SliderOthers == '1') :?><br>
<?php endif; ?>
  <?php while($this->next()): ?>
					...
					<div class="col">
						<div class="container">
							...
							<div class="front" style="background-image: url(<?php echo thumb2($this); ?>)">
							    <?php else: ?>
							    <div class="front" style="background-image: url(/usr/themes/bearsimple/assets/images/cover.png)">
							        <?php endif; ?>
								<div class="inner">
									<p><a style="color:white"><?php $this->title(articletitlenum(), '...') ?></a></p>
