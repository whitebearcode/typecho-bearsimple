 ...
 <div class="splide">
  <div class="splide__track" style="border-radius:10px">
		...
		<?php foreach (sliderget() as $sliderpic) { ?>
			<li class="splide__slide"><a href="<?php echo $sliderpic[1];?>"<?php if($this->options->Link_blank == '2'):?> target="_blank"<?php endif; ?>><img src="<?php $this->options->siteUrl() ?>/index.php/bearthumb?img=<?php echo $sliderpic[0];?>"></a>
</li>
			<?php } ?>
		</ul>
  </div>
   ...
   <?php while($this->next()): ?>
			<div class="bs-col" hrefs="<?php $this->permalink() ?>">
				<div class="bs-card" <?php if($this->options->articleradius): ?>style="border-radius:<?php $this->options->articleradius(); ?>px"<?php endif; ?>>
					...
					<?php endif; ?>
					<div class="bs-card-body" <?php if($this->options->articleradius): ?>style="border-radius:<? $this->options->articleradius(); ?>px"<?php endif; ?>>
