...
<?php if(Bsoptions('Slidersss') == true && Bsoptions('SliderOthers') == true) :?>
  ...
  <div hrefs="<?php echo $sliderpic['slider__url'];?>"><img src="<?php echo $sliderpic['slider__pic'];?>" title="<?php echo $sliderpic['slider__title'];?>"></div>
  <?php } ?>
</div>
...
<?php endif; ?>
  ...
  <div class="blog-card">
    ...
    <div class="description">
      ...
      <p class="read-more">
        <a href="<?php $this->permalink() ?>" class="ui button" <?php if(Bsoptions('article_blank')== true): ?>target="_blank"<?php endif; ?>>阅读全文</a>
      </p>
    </div>
  </div>
   <?php endwhile; ?>
...
<div class="post-meta">
			<?php if(Bsoptions('Article_time') == true): ?><time datetime="<?php $this->date('c'); ?>" itemprop="datePublished"><?php $this->date(); ?></time><?php endif; ?><?php if(Bsoptions('show_cate') == true):?> | <i class="folder outline icon"></i><?php $this->category(','); ?><?php endif; ?><?php if(Bsoptions('show_comment') == true):?> | <i class="comment outline icon"></i><a itemprop="discussionUrl" href="<?php $this->permalink() ?>#comments"><?php $this->commentsNum('0', '1', '%d'); ?></a><?php endif; ?>
			</div>
			<?php endif; ?>
		...
		<!--给文章简介加上内页链接 -->
			...
			<?php $this->fields->excerpt(); ?>
			<?php endif; ?>
			</div><?php endif; ?><br><p class="readmore" style="float:right;"><a href="<?php $this->permalink() ?>" <?php if(Bsoptions('article_blank')== true): ?>target="_blank"<?php endif; ?>>阅读全文</a></p></div></div>
