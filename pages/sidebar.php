...
<div class="pure-u-1-4 hidden_mid_and_down">
    <div id="sidebar" class="ui sticky">
...
<div class="ui cards">
  <a class="gray card"  href="<?php $this->options->AdControl1Url() ?>">
    ...
    <div class="image">
      <img src="<?php if(empty($this->options->AdControl1Src)) :?><?php AssetsDir();?>assets/image/white-image.png<?php else: ?><?php $this->options->AdControl1Src() ?><?php endif; ?>">
...
<div class="ui large icon input pc">
...
</center><?php else: ?> <?php echo BearSimpleFriendLinkBr($this->options->FriendLink )?><?php endif; ?></div>
<?php endif; ?>
...
<div class="ui cards">
   <a class="gray card"  href="<?php $this->options->AdControl2Url() ?>">
    <div class="image">
      <img src="<?php if(empty($this->options->AdControl2Src)) :?><?php AssetsDir();?>assets/image/white-image.png<?php else: ?><?php $this->options->AdControl2Src() ?><?php endif; ?>">
    </div>
  </a>
  </div>
  <?php endif; ?>
