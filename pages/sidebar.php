...
<div class="ui large transparent icon input">
  ...
  <i onclick="javascript:search.submit();" class="search link icon"></i>
</div>
 </form>
 </ul>
</div>
...
?>
    ...
    <div class="date" style="margin-top:3px">
      ...
      <div class="summary">
        <?php $obj->author(); ?> 在《<a href="<?php echo get_article_link($obj->cid); ?>"><?php echo get_article_title($obj->cid); ?></a>》发表了评论:
      </div>
...
<a href="<?php echo $FriendLinks[2]; ?>" title="<?php echo $FriendLinks[1]; ?>"><?php echo $FriendLinks[0]; ?>
</a><ul></ul> 
