      ...
      <div class="ui inverted dimmer">
        <div class="content">
          <div class="center">
            ...
            <a href="<?php if($this->options->AuthorAvatarClickLink) :?><?php $this->options->AuthorAvatarClickLink() ?><?php else :?>#<?php endif; ?>"<?php if($this->options->Link_blank == '2'):?> target="_blank"<?php endif; ?> class="ui primary button"><?php if($this->options->AuthorAvatarClickText) :?><?php $this->options->AuthorAvatarClickText() ?><?php else :?>暂时没有<?php endif; ?></a>
          </div>
        </div>
      </div>
...
<form name="search" class="ui form" role="search" method="get">
<div class="ui large transparent icon input">
  <input id="sidebarsearch" type="text" name="s" placeholder="输入完毕后按回车键">
...
<a href="<?php echo $FriendLinks[2]; ?>" title="<?php echo $FriendLinks[1]; ?>"<?php if($this->options->Link_blank == '2'):?> target="_blank"<?php endif; ?>><?php echo $FriendLinks[0]; ?>
</a><ul></ul> 
