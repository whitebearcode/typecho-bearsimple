...
if ($this->options->Lightbox == '1' || $this->options->Watermark == '1'){
    $pattern = '/\<img.*?src\=\"(.*?)\"[^>]*>/i';
    $replacement = '
<img src="$1" class="layimg" data-img2blob="$1" alt="'.$this->title.'" title="点击放大图片">';
