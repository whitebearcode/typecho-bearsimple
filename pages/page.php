...
<script>
			...
			window.poster_info={
				bgimgurl   : "http://b3.typecho.ru/usr/themes/bearsimple/assets/vendors/bs-poster/static/images/xuxian.png",
				...
				cat_name   : "<?php if(empty($this->category)):?>页面<?php else:?><?php $this->category(',',false); ?><?php endif; ?>",
