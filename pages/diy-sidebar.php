...
<div class="progress" style="height: 10px;">
<div class="progress-bar">
                            <div class="progress-inner progress-inner-4"  id="hourbar"></div>
                        </div>
...
<div class="progress" style="height: 10px;">
<div class="progress-bar">
                            <div class="progress-inner progress-inner-5"  id="minutebar"></div>
                        </div>
...
</aside></div>    <?php if(Bsoptions('hcsticky') == '1') :?></div><?php endif; ?>
