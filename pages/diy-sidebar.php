...
<div class="pure-u-1-4 hidden_mid_and_down">
        <?php if(Bsoptions('hcsticky') == '1') :?><div class="ui sticky"><?php endif; ?>
...
<div class="widget">
<!--右侧广告模块1-->
    <?php billboard(Bsoptions('AdControl1Src'),'sidebar'); ?>
  </div>
  <?php endif; ?>
  <?php endif; ?>
...
<?php Typecho_Widget::widget('Widget_Stat')->to($stat); ?>
  ...
  <a class="ui label" style="margin-right:-2px">
      ...
      <?php endif; ?>
  <?php if(!empty(Bsoptions('Github_URL')) || !empty(Bsoptions('Wechat_QRCODE')) || !empty(Bsoptions('QQ_QRCODE')) || !empty(Bsoptions('Facebook_URL')) || !empty(Bsoptions('Twitter_URL')) ||!empty(Bsoptions('Telegram_URL')) ||!empty(Bsoptions('Weibo_URL'))) :?>
          <div class="bs_newAuthor_card-social-accounts">
...
<div class="widget"><?php if(Bsoptions('rightType') !== "0"): ?><div class="ui <?php if(Bsoptions('rightType') == "1"): ?>raised<?php endif; ?><?php if(Bsoptions('rightType') == "2"): ?>stacked<?php endif; ?><?php if(Bsoptions('rightType') == "3"): ?>tall stacked<?php endif; ?><?php if(Bsoptions('rightType') == "4"): ?>piled<?php endif; ?> segments" <?php if(Bsoptions('rightradius')): ?>style="border-radius:<?php echo Bsoptions('rightradius'); ?>px"<?php endif; ?>>
 <div class="ui segment"><?php endif; ?>
    <div class="widget-title"><i class="fa fa-reply"> 最新评论</i></div>
    <?php lastComments(); ?>
...
<!--友链模块-->
<div class="widget"><?php if(Bsoptions('rightType') !== "0"): ?><div class="ui <?php if(Bsoptions('rightType') == "1"): ?>raised<?php endif; ?><?php if(Bsoptions('rightType') == "2"): ?>stacked<?php endif; ?><?php if(Bsoptions('rightType') == "3"): ?>tall stacked<?php endif; ?><?php if(Bsoptions('rightType') == "4"): ?>piled<?php endif; ?> segments" <?php if(Bsoptions('rightradius')): ?>style="border-radius:<?php echo Bsoptions('rightradius'); ?>px"<?php endif; ?>>
 <div class="ui segment"><?php endif; ?><div class="widget-title"><i class="fa fa-external-link"> 友情链接</i></div><ul></ul><?php if(empty(Bsoptions('FriendLink'))) :?> <center><div class="ui compact segment">
  <h2 class="ui header">
...
</div></div>    <?php if(Bsoptions('hcsticky') == '1') :?></div><?php endif; ?>
