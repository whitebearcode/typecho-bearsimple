  ...
  <div class="pure-g animate__animated animate__<?php echo Bsoptions('Animate') ?>" id="layout">
      ...
      <div class="pure-u-1 pure-u-md-3-4">
         ...
         <div id="bearsimple-scroll">
          ...
          <div class="ui <?php if(Bsoptions('postType') == "1"): ?>raised<?php endif; ?><?php if(Bsoptions('postType') == "2"): ?>stacked<?php endif; ?><?php if(Bsoptions('postType') == "3"): ?>tall stacked<?php endif; ?><?php if(Bsoptions('postType') == "4"): ?>piled<?php endif; ?> segment"<?php if(Bsoptions('postradius')): ?> style="border-radius:<?php echo Bsoptions('postradius'); ?>px"<?php endif; ?>>
