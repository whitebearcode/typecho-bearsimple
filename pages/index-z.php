...
<div class="pure-g" id="layout">
  ...
  <div hrefs="<?php echo $sliderpic['slider__url'];?>"><img <?php echo lazyload('auto',$sliderpic['slider__pic']); ?>src="<?php echo $sliderpic['slider__pic'];?>" data-src="<?php echo $sliderpic['slider__pic'];?>" title="<?php echo $sliderpic['slider__title'];?>"></div>
  <?php } ?>
</div>
...
<?php endif; ?>
  ...
  <div class="blog-card">
    <div class="meta">
      <div class="photo<?php if(Bsoptions('Lazyload') == true): ?> lazyload bs-blur<?php endif; ?>" data-bg="<?php echo thumb($this); ?>" style="background-image: url(<?php if(thumb($this) !== "null"): ?><?php echo thumb($this); ?><?php else:?><?php AssetsDir();?>assets/images/newstyle_default.jpg<?php endif; ?>)"></div>
    </div>
