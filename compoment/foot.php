...
<footer id="footer" role="contentinfo" class="break">
 <?php if(Bsoptions('CustomizationFooterCode')): ?><?php echo Bsoptions('CustomizationFooterCode'); ?><br><?php endif; ?>
    ...
    <?php _e('Powered by <a href="http://www.typecho.org">Typecho</a> | Template by<a href="https://github.com/whitebearcode/typecho-bearsimple"><em data-emoji=":bear:"></em>BearSimple</a>  '); ?>
...
<div class="goTop" id="js-go_top"><?php if(!empty(Bsoptions('TopSrc'))) :?><img src="<?php echo Bsoptions('TopSrc'); ?>" alt="回到顶部"><?php else: ?><svg width="20" height="20" viewBox="0 0 48 48" fill="none" xmlns="http://www.w3.org/2000/svg"><path d="M24.0083 14.1006V42.0001" stroke="#000000" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 26L24 14L36 26" stroke="#000000" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/><path d="M12 6H36" stroke="#000000" stroke-width="3" stroke-linecap="round" stroke-linejoin="round"/></svg><?php endif; ?></div>
<?php endif; ?>
...
if (typeof Prism !== 'undefined') {
        var pres = document.getElementsByTagName('pre'); for (var i = 0; i < pres.length; i++) { if (pres[i].getElementsByTagName('code').length > 0) pres[i].className  = '<?php if($this->options->showLineNumber == '1') :?>line-numbers <?php endif; ?>language-';document.getElementsByTagName('code').className  = 'language-'; }
...
<script>
if (typeof Prism !== 'undefined') {
        var pres = document.getElementsByTagName('pre'); for (var i = 0; i < pres.length; i++) { if (pres[i].getElementsByTagName('code').length > 0) pres[i].className  = '<?php if(Bsoptions('showLineNumber') == true) :?>line-numbers <?php endif; ?>language-';document.getElementsByTagName('code').className  = 'language-'; }
        Prism.highlightAll(true,null);
    };
    </script>
<?php endif; ?>
