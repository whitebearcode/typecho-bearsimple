...
function isLogin(){
    ...
    case 1:
       ...
       $('#bs-islogin2').html('<a href="<?php $this->options->siteUrl(); ?><?php if($this->options->rewrite == 0 || $this->options->rewrite == ''):?>index.php/<?php endif;?>usercenter" pjax="no"><?php _e('进入用户中心'); ?></a>').show();
       <?php endif; ?>
    $('#bs-login').hide();
    break;
    default:
...
<script src="//cdn.staticfile.org/mathjax/2.7.9/MathJax.js?config=TeX-AMS-MML_HTMLorMML"></script>	
<?php endif; ?>
<?php if(Bsoptions('Mermaid') == true):?>
<script type="module">
    import mermaid from '//cdn.staticfile.org/mermaid/10.1.0/mermaid.esm.min.mjs';
...
<!-- 引入BearSimple全局配置JS -->
<script type="text/javascript" src="//cdn.staticfile.org/fomantic-ui/2.9.3/semantic.min.js"></script>
