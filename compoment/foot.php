...
<script src="//cdn.staticfile.org/fancyapps-ui/5.0.28/fancybox/fancybox.umd.min.js"></script>
<?php endif; ?>
	<?php if(Bsoptions('MathJax') == true):?>
<script src="//cdn.staticfile.org/mathjax/2.7.9/MathJax.js?config=TeX-AMS-MML_HTMLorMML" defer></script>	
<?php endif; ?>
<?php if(Bsoptions('Mermaid') == true):?>
<script type="module">
    import mermaid from '//cdn.staticfile.org/mermaid/10.6.1/mermaid.esm.min.mjs';
...
<?php endif;?>
<!-- 引入全局控制 -->
<script type="text/javascript" src="https://cdn.staticfile.org/fomantic-ui/2.9.3/semantic.min.js" defer></script>
