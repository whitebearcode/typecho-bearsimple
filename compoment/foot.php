...
<footer id="footer" role="contentinfo" class="break">
 <?php if(Bsoptions('CustomizationFooterCode')): ?><?php echo Bsoptions('CustomizationFooterCode'); ?><br><?php endif; ?>
    ...
    <?php _e('Powered by <a href="http://www.typecho.org">Typecho</a> | Template by<a href="https://githue.com/whitebearcode/typecho-bearsimple"><em data-emoji=":bear:"></em>BearSimple</a>  '); ?>
