...
<?php endif; ?>
 ...
 <title><?php getTitle($this); ?></title>
    ...
    <meta name="description" content="<?php if($seo_description != '') echo $seo_description; else $this->excerpt(50); ?>" />
    <meta property="og:title" content="<?php getTitle($this); ?>" />
    <meta property="og:description" content="<?php if($seo_description != '') echo $seo_description; else $this->excerpt(50); ?>" />
    <meta property="og:site_name" content="<?php getTitle($this); ?>" />
