  ...
  CSF::createSection( $prefix, array(
    ...
    'fields' => array(
      array(
            ...
            'options'     => array('1' => '开启普通算数加法验证', '11' => '开启普通算数减法验证', '2' => '开启Vaptcha验证','2-1' => '开启顶象验证','2-2' => '开启Cloudflare Turnstile验证', '22' => '开启拼图滑块验证','3' => '关闭行为验证'),
            'default' => '1',
        ), 
      array(
