  ...
  CSF::createSection( $prefix, array(
    ...
    array(
        ...
        array(
            ...
            'type'    => 'switcher',
            'title'       => '是否开启文章分类加密',
            'subtitle' => '您可以对一些不想显示的隐私分类设置密码，本项对已登录用户[管理员身份]无效。',
            'default' => false,
        ),
        array(
            ...
            'subtitle' => '若开启，则加密分类的所有文章均正常显示在首页中，本项对已登录用户[管理员身份]无效。',
            'default' => false,
        ...
        'type'  => 'textarea',
        'title' => '图文样式自定义随机图片',
        'after' => '请填入图文样式自定义随机图片，多张图片使用|间隔<br>若为随机图API，仅需填写一个即可，或者可以填写多个随机图API地址，也是使用|间隔<br><a style="color:red">提醒：图片地址建议不要带参数之类的，可能会出现无法显示的情况</a>',
        'dependency' => array( 'Article_forma', 'any', '1,3,5' ),
      ),
      array(
            'id'      => 'show_cate',
