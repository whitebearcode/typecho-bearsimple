...
<div class="ui labeled button" tabindex="0">
  ...
  <a class="ui basic black left pointing label" href="https://github.com/whitebearcode/typecho-bearsimple">
    ...
    $Version = file_get_contents('http://version.typecho.bearlab.in/version-bearsimple.php');
...
if($options->VerifyChoose == '22'){
 ...
 //特效设置
    ...
    $Lightbox = new Typecho_Widget_Helper_Form_Element_Select('Lightbox', array('1' => '开启Lightbox灯箱效果',  '2' => '关闭Lightbox灯箱效果'), '1', '是否开启Lightbox灯箱效果', '使用Lightbox灯箱效果听说有BUFF加成~');
...
$Menu = new Typecho_Widget_Helper_Form_Element_Textarea('Menu', null, '', '自定义导航', '可自由添加前台自定义导航，例子:<br>https://www.baidu.com|百度<br>https://www.qq.com|QQ<br>也就是导航链接|导航名，多个直接换行即可');
    ...
    $FourTotalHidden = new Typecho_Widget_Helper_Form_Element_Select('FourTotalHidden', array('1' => '显示',  '2' => '不显示'), '1', '是否显示四项统计', '若选择开启，则博主信息栏将显示四项统计：文章、评论、分类、阅读量');
