...
array(
                'type'    => 'notice',
            'style'   => 'info',
                'content' => '<ul style="margin:0 auto;"><li>BearSimple主题版本：<img style="vertical-align: middle;" src="https://img.shields.io/github/v/release/whitebearcode/typecho-bearsimple"></li><li>PHP版本：'.PHP_VERSION.'</li><li>网站服务器：'.$_SERVER['SERVER_SOFTWARE'].'</li><li>数据库：'.$db->getAdapterName().'[Version：'.$db->getVersion().']</li><li>Typecho版本：'.$Tyoptions->version.'</li><li>User Agent信息：'.$_SERVER['HTTP_USER_AGENT'].'</li></ul>',
        ),
...
<?php
    ...
    $params = [
        'args'=> [
            'framework_title' => 'Bearsimple V2.0.1.1',
