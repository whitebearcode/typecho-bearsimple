...
<h4><font color=red>检查需要耗费服务器资源，且可能因为友链的数量增多而影响检查的速度，建议执行时间为每天一次即可</font></h4>
  ...
  CSF::createSection( $prefix, array(
    ...
    'fields' => array(
        ...
        array(
            ...
            'type'    => 'content',
            'title'       => '邮件发送模板修改',
            'content'=> '<a href="extending.php?panel=BsCore/pages/panel.php&act=editemailtemplates" class="button button-primary csf--button" target="_blank">戳这里修改邮件模板</a>',
            'dependency' => array( 'Smtp_open', '==', 'true' ),
