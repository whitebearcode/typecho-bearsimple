...
$Article_forma = new Typecho_Widget_Helper_Form_Element_Select('Article_forma', array('1' => '简洁图文',  '2' => '纯文字','3' => '图底文字','4' => '纯文字2'), '2', '选择首页、分类等页面输出文章的展现样式', '若选择图文或图底文字，则当存在图片时展现图文样式，优先级：文章封面->附件首图->文章首图->自定义随机图片，无图片时不显示<br><font color="red">简洁图文样式请先在图片设置-图片剪裁设置中设置允许的域名，否则封面不显示</font>');
