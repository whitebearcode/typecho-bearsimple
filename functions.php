...
break;
    ...
    'fields' => array(
        array(
            ...
            'options'     => array('1' => '本地存储',  '2' => '腾讯云COS',  '3' => '阿里云OSS(公测)',  '4' => '又拍云USS(内测中，暂无法使用)',  '5' => '七牛云Kodo(内测中，暂无法使用)',  '6' => '火山云TOS(内测中，暂无法使用)',  '7' => '百度云BOS(内测中，暂无法使用)',  '8' => '天翼云CT-OOS(内测中，暂无法使用)',  '9' => '移动云EOS(内测中，暂无法使用)', '10' => '华为云OBS(内测中，暂无法使用)', '11' => '优刻得US3(内测中，暂无法使用)'),
            'default' => '1',
        ), 
        //腾讯云
        array(
        ...
        array(
         ...
         array(
            ...
            'type'        => 'text',
            'title'       => '对象链接附带后缀',
            'after' => '该项针对有需要在对象链接后面添加一些参数的用户，若不需要请留空<br>填写示例: ?v=1&type=webp',
            'dependency' => array( 'bucket_choose', '==', '2' ),
        ), 
        //阿里云
        array(
