...
'',_t('第一个标签对应的豆瓣电影ID'), _t('在此填写豆瓣电影中的电影ID，多部电影使用英文逗号分隔，他将显示在前台我的追剧页面中的第一个追剧标签内'));
...
'',_t('第二个标签对应的豆瓣电影ID'), _t('在此填写豆瓣电影中的电影ID，多部电影使用英文逗号分隔，他将显示在前台我的追剧页面中的第二个追剧标签内'));
...
'',_t('第三个标签对应的豆瓣电影ID'), _t('在此填写豆瓣电影中的电影ID，多部电影使用英文逗号分隔，他将显示在前台我的追剧页面中的第三个追剧标签内'));
...
'',_t('第一个标签对应的豆瓣音乐ID'), _t('在此填写豆瓣音乐中的音乐ID，多首音乐使用英文逗号分隔，他将显示在前台我的音乐歌单页面中的第一个音乐歌单标签内'));
...
'',_t('第二个标签对应的豆瓣音乐ID'), _t('在此填写豆瓣音乐中的音乐ID，多首音乐使用英文逗号分隔，他将显示在前台我的音乐歌单页面中的第二个音乐歌单标签内'));
...
'',_t('第三个标签对应的豆瓣音乐ID'), _t('在此填写豆瓣音乐中的音乐ID，多首音乐使用英文逗号分隔，他将显示在前台我的音乐歌单页面中的第三个音乐歌单标签内'));
