...
break;
    ...
    'fields' => array(
        array(
            ...
            'options'     => array('1' => '本地存储',  '2' => '腾讯云COS',  '3' => '阿里云OSS(公测)',  '4' => '七牛云Kodo(公测)',  '5' => '又拍云USS(公测)',  '6' => '百度云BOS(内测中，暂无法使用)', '7' => '华为云OBS(内测中，暂无法使用)'),
            'default' => '1',
        ), 
        //腾讯云
        array(
...
alert("升级失败");
    ...
    'fields'      => array(
        array(
            'type'    => 'notice',
            'style'   => 'info',
            'content' => '<strong>注意事项</strong><p> <ul><li>1、若您有开启缓存功能，那么在升级完成后都请关闭一次缓存功能提交保存后再启用。</li><li>2、若出现在线升级卡顿无法升级，可能是您的服务器网络到升级节点之间存在异常，则需要手动覆盖升级或者稍等一会再试试。</li><li>3、若升级完毕后出现报错，可尝试通过手动覆盖新版本来进行修复，下载地址:<a href="https://files.bear.dance/Bearsimple_v'.themeVersionOnly().'.release.zip">戳这里</a></ul></p>',
        ),
array(
                    'type' =>'content',
                    'content' => $htmls,
