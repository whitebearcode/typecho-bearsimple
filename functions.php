...
//手机端是否显示搜索功能
    $phonesearch_hidden = new Typecho_Widget_Helper_Form_Element_Select('phonesearch_hidden', array('1' => '是',  '2' => '否'), '2', '手机端是否显示搜索功能', '若开启，则手机端网站顶部LOGO下方，导航上方将显示搜索功能，PC不显示，本项服从于区块设置中的是否开启右侧搜索区块，该项关闭时本项也无效。');
    $phonesearch_hidden->setAttribute('class', 'bearui_content bearui_global');
    $form->addInput($phonesearch_hidden->multiMode());
