...
<?php if($this->options->Animate == "close" || $this->options->Animate == null): ?>
 <div class="pure-g" id="layout">
  ...
  <?php if(!empty($this->options->douban_music_note)): ?> 
    <div class="ui segment">
  <i class="red heart icon"></i>
  <?php $this->options->douban_music_note();?>
</div>
<?php endif; ?>
...
str += '<div class="ui fluid card" style="word-break:break-all;"><div class="blurring dimmable image"><div class="ui dimmer"><div class="content"><div class="center"><a class="ui inverted button" href="' + list[i]['url'] + '"<?php if($this->options->Link_blank == '2'):?> target="_blank"<?php endif; ?>>我也要听</a></div></div></div><img class="lazyload" id="imga" data-src="'+ list[i]['cover'].replace('http://','//') +'" referrerPolicy="no-referrer"></div><div class="content" style="text-align:center;"><a class="header" href="' + list[i]['url'] + '"<?php if($this->options->Link_blank == '2'):?> target="_blank"<?php endif; ?>>《' + list[i]['title'] + '》</a><div class="meta"><a>歌手：' + list[i]['singer'] + '</a></div></div></div>'
}
