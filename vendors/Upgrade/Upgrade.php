...
downFile("https://upgrade.bear-studio.net/Typecho/Bearsimple/Bearsimple.zip",str_replace('bearsimple/vendors/Upgrade','',dirname(__FILE__)));
$zip=new ZipArchive;
 ...
 unlink(str_replace('Upgrade','',dirname(__FILE__)).'CheckTool/Http.Code');
 }
 echo json_encode($data, JSON_UNESCAPED_UNICODE);
 }
}
