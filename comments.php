...
<div id="comments" class="comment">
  ...
  <img src="<?php imgravatarq($comments->mail); ?>?s=65&r=G&d=">
...
<div class="OwO"></div>
<?php endif ; ?>
                <textarea rows="8" cols="50" <?php if($this->options->Entermaxlength == '1') :?>maxlength="<?php $this->options->Entermaxlengths();?>"<?php endif ; ?> onkeyup="wordStatic(this);" name="text" id="textarea" placeholder="嘿~ 大神，别默默的看了，快来点评一下吧" class="textarea <?php if($this->options->Emoji == '1') :?>OwO-textarea<?php endif ; ?>" required ><?php $this->remember('text'); ?></textarea>
            <br>
