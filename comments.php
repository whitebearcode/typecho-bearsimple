...
<a class="ui big circular image avatar">
     ...
     <div class="content">
      <a class="author" style="margin-left:10px"><a><?php $comments->author(); ?></a><?php 
        if ($comments->authorId == $comments->ownerId) {
    ...
    <div class="vaptcha-init-main">
        <div class="vaptcha-init-loading">
            ...
            <?php if($this->options->VerifyChoose == '22') :?>
             ...
             <span class="ui button" id="qverify" onclick="Verify();" disabled><i class="user secret icon"></i><?php if(empty($this->options->Verify22_Buttontext)){echo '人机验证';}else{
...
<?php else:?>
<?php _e('<div class="ui big label">评论已关闭</div>'); ?>
</div></div>
<?php endif; ?>