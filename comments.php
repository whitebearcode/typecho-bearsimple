...
<?php if($this->options->Emoji == '1') :?>
  ...
  <?php endif; ?>
       <h3 class="ui dividing header" id="comments"><i class="comments outline icon" data-content="若您进行评论则表示您同意本站使用Cookie来记录您所填写的个人信息以便您在后面能够更便捷的进行评论。" data-variation="inverted"></i>评论区 </h3>
...
<div class="field">
        ...
        <i id="randname"  class="circular bolt link icon"></i>
    		...
    		<?php if($this->options->commentsRequireURL == '1'): ?>
    		<div class="field">
